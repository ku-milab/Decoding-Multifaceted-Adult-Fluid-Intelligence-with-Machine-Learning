...
other_csv_path = '/media/dwh/b9bd8b27-0895-494e-8a2a-2d019ae4bf2c/UKB/FinalFinal_Version_1107/ukb669045_250926_sohyun_1.csv'
brain_csv_path = '/media/dwh/b9bd8b27-0895-494e-8a2a-2d019ae4bf2c/UKB/FinalFinal_Version_1107/ukb669045_250926_sohyun_2.csv'
disease_csv_path = '/media/dwh/b9bd8b27-0895-494e-8a2a-2d019ae4bf2c/UKB/FinalFinal_Version_1107/ukb669045_251002_sohyun.csv'
disease_csv_path2 = '/media/dwh/b9bd8b27-0895-494e-8a2a-2d019ae4bf2c/UKB/FinalFinal_Version_1107/ukb669045_251004_sohyun.csv'
...
### Disease-related
# Subfields of field #1712 (first occurrence): Full list of diseases
...
# Remove duplicate eids (use only the first row if present)
brain_df = brain_df.sort_values('eid').drop_duplicates(subset=['eid'], keep='first')
